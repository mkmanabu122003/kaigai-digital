  ...
  return (
    <div className="mx-auto max-w-[740px] px-4 py-12">
      ...
      <div className="article-content">
        ...
        <h2 id="experience">1. 公開情報の整理と解説</h2>
        <p>
          記事内で紹介するサービス・商品は、各社の公式情報・公開仕様・第三者公開レビューなどを整理し、選び方を解説する形で扱っています。
          「机上の知識」「他サイトの情報の寄せ集め」ではなく、出典が明確な情報をもとに、編集部の視点で整理することを心がけています。
        </p>
        <ul>
          <li>料金・機能・対応国は各サービスの公式サイト掲載情報をもとに整理する</li>
          <li>ユーザーの評価については Trustpilot・App Store・知恵袋などの公開レビューを参照する</li>
        ...
        <ul>
          ...
          <li>他サイトのコピーではなく、編集部の視点で整理・解説されていること</li>
          <li>情報の出典が明確であること（公式サイト・第三者公開情報を参照）</li>
          <li>事実と編集部の見解を明確に区別すること</li>
        </ul>
