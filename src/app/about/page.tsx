  ...
  return (
    <div className="mx-auto max-w-[740px] px-4 py-12">
      ...
      <div className="article-content">
        ...
        <p>
          {siteConfig.name}は、海外渡航経験者・IT専門家による編集チームが運営しています。
          記事は専属の執筆者が実体験・実測に基づいて作成し、編集部による校正・ファクトチェックを経て公開しています。
        </p>
        <p>
        ...
        <ul>
          <li>実際に使用したサービスのみをおすすめする</li>
          <li>料金・機能の記述は公式情報を確認のうえ掲載する</li>
